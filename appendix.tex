	...
	%	\subsection{Sources of the twenty-four RNA-Seq data sets}\label{app:24experiments} 
		\begin{table}[H]
			...
			\begin{tabular}{lrlrr} \hline
				...
				&N                        &Quality\tablefootnote{The number of mapped reads divided 
				by 
				...
				is 
					...
					& 
				88.40\% \\
				GSE54677\tablefootnote{Out of the 24 samples,  the total number of RNA-Seq samples 
				is 
					20.} & \cite{moissiard2014transcriptional}  & leaves                      & 20 
					& 
				85.20\% \\ \hline
